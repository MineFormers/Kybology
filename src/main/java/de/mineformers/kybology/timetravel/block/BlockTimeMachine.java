...
import de.mineformers.kybology.timetravel.travelling.timemachine.TMPartBase;
 ...
 * 
 */
public class BlockTimeMachine extends BlockKybology {
                ...
                if (!player.isSneaking()) {
                    if (tile.getPart().isValidMultiblock())
                        if (!((TMPartPanel) tile.getPart())
                                .getModuleConflicts())
                            player.openGui(KybologyTimeTravel.instance,

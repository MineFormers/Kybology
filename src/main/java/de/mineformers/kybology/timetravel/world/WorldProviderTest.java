...
public class WorldProviderTest extends WorldProvider {
	...
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerHell(
		        KybologyTimeTravel.TutorialBiome, this.dimensionId, this.dimensionId);
		this.dimensionId = DimIds.REDWOOD;
		this.hasNoSky = false;
	}

	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderTest(this.worldObj, this.worldObj.getSeed(),
		        false);
	}
	...
	public String getWelcomeMessage() {
		if ((this instanceof WorldProviderTest)) {
			return "Travelling back in time...";
		}
		return null;
	}

...
import de.mineformers.kybology.timetravel.world.gen.MapGenTutorialCaves;
import de.mineformers.kybology.timetravel.world.gen.WorldGenTutorialHugeTree;
...
public class ChunkProviderTest implements IChunkProvider {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		// BASIC TREES
		/*
		 * for (int c = 60; c > 0; c--) { int j2 = var4 + rand.nextInt(16) + 8;
		 * int l3 = rand.nextInt(120); int j5 = var5 + rand.nextInt(16) + 8; if
		 * ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2,
		 * l3 - 1, j5) == Block.grass.blockID)) { new WorldGenTutorialTree(true,
		 * 6 + rand.nextInt(8), 0, 0, false) .generate(worldObj, rand, j2, l3,
		 * j5); } } for (int c = 50; c > 0; c--) { int j2 = var4 +
		 * rand.nextInt(16) + 8; int l3 = rand.nextInt(120); int j5 = var5 +
		 * rand.nextInt(16) + 8; if ((worldObj.getBlockId(j2, l3, j5) == 0) &&
		 * (worldObj.getBlockId(j2, l3 - 1, j5) == Block.grass.blockID)) { new
		 * WorldGenTutorialTree(true, 4 + rand.nextInt(8), 0, 0, false)
		 * .generate(worldObj, rand, j2, l3, j5); } } for (int c = 50; c > 0;
		 * c--) { int j2 = var4 + rand.nextInt(16) + 8; int l3 =
		 * rand.nextInt(120); int j5 = var5 + rand.nextInt(16) + 8; if
		 * ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2,
		 * l3 - 1, j5) == Block.grass.blockID)) { new WorldGenTutorialTree(true,
		 * 8 + rand.nextInt(8), 0, 0, false) .generate(worldObj, rand, j2, l3,
		 * j5); } } for (int c = 50; c > 0; c--) { int j2 = var4 +
		 * rand.nextInt(16) + 8; int l3 = rand.nextInt(120); int j5 = var5 +
		 * rand.nextInt(16) + 8; if ((worldObj.getBlockId(j2, l3, j5) == 0) &&
		 * (worldObj.getBlockId(j2, l3 - 1, j5) == Block.grass.blockID)) { new
		 * WorldGenTutorialTree(true, 10 + rand.nextInt(8), 0, 0,
		 * false).generate(worldObj, rand, j2, l3, j5); } } for (int c = 50; c >
		 * 0; c--) { int j2 = var4 + rand.nextInt(16) + 8; int l3 =
		 * rand.nextInt(120); int j5 = var5 + rand.nextInt(16) + 8; if
		 * ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2,
		 * l3 - 1, j5) == Block.grass.blockID)) { new WorldGenTutorialTree(true,
		 * 15 + rand.nextInt(4), 0, 0, false).generate(worldObj, rand, j2, l3,
		 * j5); } } for (int c = 60; c > 0; c--) { int j2 = var4 +
		 * rand.nextInt(16) + 8; int l3 = rand.nextInt(120); int j5 = var5 +
		 * rand.nextInt(16) + 8; if ((worldObj.getBlockId(j2, l3, j5) == 0) &&
		 * (worldObj.getBlockId(j2, l3 - 1, j5) == Block.grass.blockID)) { new
		 * WorldGenTutorialTree(true, 6 + rand.nextInt(8), 0, 0, false)
		 * .generate(worldObj, rand, j2, l3, j5); } } // Forest Trees for (int c
		 * = 60; c > 0; c--) { int j2 = var4 + rand.nextInt(16) + 8; int l3 =
		 * rand.nextInt(120); int j5 = var5 + rand.nextInt(16) + 8; if
		 * ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2,
		 * l3 - 1, j5) == Block.grass.blockID)) { new
		 * WorldGenTutorialForestTree(true).generate(worldObj, rand, j2, l3,
		 * j5); } }
		 */
		...
		for (int c = 7; c > 0; c--) {
			...
			if ((worldObj.getBlockId(j2, l3, j5) == 0)
			        && (worldObj.getBlockId(j2, l3 - 1, j5) == Block.grass.blockID)) {
				new WorldGenTutorialHugeTree(true)// true, 15 + rand.nextInt(8),
				                                  // 0, 0)

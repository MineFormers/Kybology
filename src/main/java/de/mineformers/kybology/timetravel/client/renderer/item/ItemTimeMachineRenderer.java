package de.mineformers.kybology.timetravel.client.renderer.item;
...
import de.mineformers.kybology.timetravel.client.model.ModelTimeMachine;
...
public class ItemTimeMachineRenderer implements IItemRenderer {
    ...
    private void renderModel(int dmg, float x, float y, float z, float scale) {
        ...
        // Bind texture
        UtilsFX.bindTexture(Textures.MODEL_TIMEMACHINE);
        ...
        switch (dmg) {
            ...
            case 3:
                ...
                break;
            case 4:
                UtilsFX.bindTexture(Textures.MODEL_TM_MODULE_DEFAULT);
                model.renderModule();
                break;
        }

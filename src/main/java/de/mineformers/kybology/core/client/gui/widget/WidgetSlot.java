...
public class WidgetSlot extends Widget {
	...
	public void draw(int mouseX, int mouseY) {
		...
		// Sides clockwise
		this.drawRectangleStretched(x + 5, y, 52, 1, width - 10, 5, 1,
		        5);
		this.drawRectangleStretched(x + width - 5, y + 5, 54, 7, 5,
		        height - 10, 5, 1);
		this.drawRectangleStretched(x + 5, y + height - 5, 52, 9,
		        width - 10, 5, 1, 5);
		this.drawRectangleStretched(x, y + 5, 46, 7, 5, height - 10, 5,
		        1);
